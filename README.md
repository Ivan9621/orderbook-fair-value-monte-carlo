...
![Monte Carlo Paths](figures/monte_carlo_example.png)
...
![Return Distribution](figures/return_distribution_example.png)
...
![Strategy Performance](figures/strategy_performance_example.png)
